...
let xyzToLinearRec2020 = Matrix3x3( 30757411.0 / 17917100.0, -6372589.0 / 17917100.0, -4539589.0 / 17917100.0,
...
extension NSColor {
    convenience init(oklchL: CGFloat, c: CGFloat, h: CGFloat, alpha: CGFloat = 1.0) {
        ...
        let p3 = xyzToP3(xyz)
        self.init(displayP3Red: p3.0, green: p3.1, blue: p3.2, alpha: alpha)
    ...
    convenience init(oklchToDisplayP3L: CGFloat, c: CGFloat, h: CGFloat, alpha: CGFloat = 1.0) {
        ...
        let p3 = xyzToP3(xyz)
        let components = [p3.0, p3.1, p3.2, alpha]
    ...
    convenience init(oklchToRec2020L: CGFloat, c: CGFloat, h: CGFloat, alpha: CGFloat = 1.0) {
        ...
        let rec2020 = xyzToRec2020(xyz)
        let components = [rec2020.0, rec2020.1, rec2020.2, alpha]
...
func xyzToP3(_ xyz: Vector3) -> Vector3 {
    let linearP3 = matrixMultiply(xyzToLinearP3, xyz)
    return (gammaCorrectSRGB(linearP3.0), gammaCorrectSRGB(linearP3.1), gammaCorrectSRGB(linearP3.2))
}

func xyzToRec2020(_ xyz: Vector3) -> Vector3 {
    let linearRec2020 = matrixMultiply(xyzToLinearRec2020, xyz)
    return (gammaCorrectRec2020(linearRec2020.0), gammaCorrectRec2020(linearRec2020.1), gammaCorrectRec2020(linearRec2020.2))
}
